...
craftingTable.removeRecipe(<item:mysticalworld:copper_axe>);
...
craftingTable.removeRecipe(<item:mysticalworld:lead_axe>);
...
craftingTable.removeRecipe(<item:mysticalworld:tin_axe>);
...
craftingTable.removeRecipe(<item:mysticalworld:amethyst_axe>);
craftingTable.removeRecipe(<item:mysticalworld:amethyst_hoe>);
craftingTable.removeRecipe(<item:mysticalworld:amethyst_knife>);